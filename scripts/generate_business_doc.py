"""
Generador del documento de contexto de negocio.

Crea docs/business_context.md con la pregunta de negocio,
las reglas de negocio (RN-01 a RN-05) y los criterios de evaluacion.
"""
from pathlib import Path


CONTENIDO = """# Contexto de Negocio - TIA Student Performance
...
def main():
    ...
    output = Path("docs/business_context.md")
    output.write_text(CONTENIDO, encoding="utf-8")
    print(f"OK: archivo creado en {output.resolve()}")
